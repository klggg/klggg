...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
  <tr> 
    <td>位置：<a href="ChangePath.php">管理備份目錄</a>&nbsp;(存放目錄：<b><?php echo $bakpath?></b>)</td>
  </tr>
</table>
<br>
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
  <tr bgcolor="#0472BC"> 
    <td width="42%" height="25" bgcolor="#0472BC"> <div align="center"><strong><font color="#FFFFFF">備份目錄名<?php echo $onclickword?></font></strong></div></td>
  ...
  <tr bgcolor="#DBEAF5"> 
    ...
    <td><div align="center">[<a href="#ebak" onclick="window.open('phome.php?phome=DoZip&p=<?php echo $file?>&change=<?php echo $change?>','','width=350,height=160');">打包並下載</a>]&nbsp;&nbsp;[<a href="RepFiletext.php?mypath=<?php echo $file?>">替換文件內容</a>]&nbsp;&nbsp;[<a href="phome.php?phome=DelBakpath&path=<?php echo $file?>&change=<?php echo $change?>" onclick="return confirm('確認要刪除？');">刪除目錄</a>]</div></td>
  </tr>
  <?php
     }
  }
