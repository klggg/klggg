...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
  <tr> 
    <td>位置：<a href="ChangePath.php">管理备份目录</a>&nbsp;(存放目录：<b><?php echo $bakpath?></b>)</td>
  </tr>
</table>
<br>
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
  <tr bgcolor="#0472BC"> 
    <td width="42%" height="25" bgcolor="#0472BC"> <div align="center"><strong><font color="#FFFFFF">备份目录名<?php echo $onclickword?></font></strong></div></td>
  ...
  <tr bgcolor="#DBEAF5"> 
    ...
    <td><div align="center">[<a href="#ebak" onclick="window.open('phome.php?phome=DoZip&p=<?php echo $file?>&change=<?php echo $change?>','','width=350,height=160');">打包并下载</a>]&nbsp;&nbsp;[<a href="RepFiletext.php?mypath=<?php echo $file?>">替换文件内容</a>]&nbsp;&nbsp;[<a href="phome.php?phome=DelBakpath&path=<?php echo $file?>&change=<?php echo $change?>" onclick="return confirm('确认要删除？');">删除目录</a>]</div></td>
  </tr>
  <?php
     }
  }
