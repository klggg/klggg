...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
  <tr> 
    <td width="51%">位置：备份数据 -&gt; <a href="ChangeDb.php">选择数据库</a>(<b><?php echo $mydbname?></b>) -&gt; <a href="ChangeTable.php?mydbname=<?php echo $mydbname?>">选择备份表</a></td>
  ...
  <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#0472BC">
    ...
    <tr> 
      <td height="25" bgcolor="#FFFFFF"> <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#DBEAF5">
          <tr> 
            <td width="22%">&nbsp;</td>
            <td> [<a href="#ebak" onclick="javascript:window.open('ListSetbak.php?mydbname=<?php echo $mydbname?>&change=1','','width=550,height=380,scrollbars=yes');">导入设置</a>]&nbsp;&nbsp;&nbsp;[<a href="#ebak" onclick="javascript:showsave.style.display='';">保存设置</a>]&nbsp;&nbsp;&nbsp;[<a href="#ebak" onclick="javascript:showreptable.style.display='';">批量替换表名</a>]</td>
          </tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
          ...
          <tr> 
            ...
            <td height="23"> <select name="dbchar" id="dbchar">
                <option value="auto"<?php echo $ddbchar=='auto'?' selected':''?>>自动识别编码</option>
                <option value=""<?php echo $ddbchar==''?' selected':''?>>不设置</option>
                <?php
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td><div align="right"><font color="#FFFFFF">查询:</font> 
                ...
                <input type="button" name="Submit32" value="显示数据表" onclick="self.location.href='ChangeTable.php?sear=1&mydbname=<?php echo $mydbname?>&keyboard='+document.ebakchangetb.keyboard.value;">
              </div></td>
          </tr>
        </table></td>
    </tr>
...
<div align="center">编码</div></td>
          ...
          <tr id=tb<?php echo $r[Name]?>> 
            ...
            <td height="23"> <div align="left"><a href="#ebak" onclick="window.open('ListField.php?mydbname=<?php echo $mydbname?>&mytbname=<?php echo $r[Name]?>','','width=660,height=500,scrollbars=yes');" title="点击查看表字段列表"> 
                <?php echo $r[Name]?>
                </a></div></td>
            <td height="23"> <div align="center">
