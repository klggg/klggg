...
<?php else:echo $default; endif; unset($_result);unset($this->magic_vars['']);unset($_magic_vars); ?>
  ...
  <div class="bodyer clearfix">
			...
			<?php unset($_magic_vars);unset($data); ?></p>
                              ...
                              <p><strong>个人统计：</strong><b class="red"><? if (!isset($this->magic_vars['var']['borrow_times'])) $this->magic_vars['var']['borrow_times'] = '';$_tmp = $this->magic_vars['var']['borrow_times'];$_tmp = $this->magic_modifier("default",$_tmp,"0");echo $_tmp;unset($_tmp); ?></b> 条借款记录&nbsp;&nbsp;&nbsp;&nbsp;<b class="red"><? if (!isset($this->magic_vars['var']['tender_times'])) $this->magic_vars['var']['tender_times'] = '';$_tmp = $this->magic_vars['var']['tender_times'];$_tmp = $this->magic_modifier("default",$_tmp,"0");echo $_tmp;unset($_tmp); ?></b> 条投标记录</p><?php unset($_magic_vars);unset($data); ?>
                            </div>
