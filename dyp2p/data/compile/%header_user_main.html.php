...
<meta http-equiv="Content-Type" content="text/html; charset=gb2312" />
    ...
    <meta name="keywords" content="<?php if (!isset($this->magic_vars['_G']['articles']['tags'])) $this->magic_vars['_G']['articles']['tags']=''; ;if (  $this->magic_vars['_G']['articles']['tags']!=""): ?><?php if (!isset($this->magic_vars['_G']['articles']['tags'])) $this->magic_vars['_G']['articles']['tags'] = ''; echo $this->magic_vars['_G']['articles']['tags']; ?><?php if (!isset($this->magic_vars['_G']['site_result']['keywords'])) $this->magic_vars['_G']['site_result']['keywords']=''; ;elseif (  $this->magic_vars['_G']['site_result']['keywords']!=""): ?><?php if (!isset($this->magic_vars['_G']['site_result']['keywords'])) $this->magic_vars['_G']['site_result']['keywords'] = ''; echo $this->magic_vars['_G']['site_result']['keywords']; ?><?php else: ?><?php if (!isset($this->magic_vars['_G']['system']['con_keywords'])) $this->magic_vars['_G']['system']['con_keywords'] = ''; echo $this->magic_vars['_G']['system']['con_keywords']; ?><?php endif; ?>" />
     <link href="<?php if (!isset($this->magic_vars['tempdir'])) $this->magic_vars['tempdir'] = ''; echo $this->magic_vars['tempdir']; ?>/css/common.css" rel="stylesheet" type="text/css" />
     <link href="<?php if (!isset($this->magic_vars['tempdir'])) $this->magic_vars['tempdir'] = ''; echo $this->magic_vars['tempdir']; ?>/css/css.css" rel="stylesheet" type="text/css" /> 
    <link href="<?php if (!isset($this->magic_vars['tempdir'])) $this->magic_vars['tempdir'] = ''; echo $this->magic_vars['tempdir']; ?>/css/user.css" rel="stylesheet" type="text/css" />
    <link href="<?php if (!isset($this->magic_vars['tempdir'])) $this->magic_vars['tempdir'] = ''; echo $this->magic_vars['tempdir']; ?>/css/new.css" rel="stylesheet" type="text/css" />
    <link href="<?php if (!isset($this->magic_vars['tempdir'])) $this->magic_vars['tempdir'] = ''; echo $this->magic_vars['tempdir']; ?>/css/shop.css" rel="stylesheet" type="text/css" />
    <link href="<?php if (!isset($this->magic_vars['tempdir'])) $this->magic_vars['tempdir'] = ''; echo $this->magic_vars['tempdir']; ?>/css/tipswindown.css" rel="stylesheet" type="text/css" />
    <link href="<?php if (!isset($this->magic_vars['tempdir'])) $this->magic_vars['tempdir'] = ''; echo $this->magic_vars['tempdir']; ?>/css/myinfo.css" rel="stylesheet" type="text/css" />
   
    <link href="<?php if (!isset($this->magic_vars['tempdir'])) $this->magic_vars['tempdir'] = ''; echo $this->magic_vars['tempdir']; ?>/css/css_inpage.css" rel="stylesheet" type="text/css" />
 ...
 <link rel="stylesheet" href="<?php if (!isset($this->magic_vars['tempdir'])) $this->magic_vars['tempdir'] = ''; echo $this->magic_vars['tempdir']; ?>/longbao/style.css" type="text/css" media="screen, projection" />
  ...
  <script src="<?php if (!isset($this->magic_vars['tempdir'])) $this->magic_vars['tempdir'] = ''; echo $this->magic_vars['tempdir']; ?>/new/js/jquery.min.js" type="text/javascript"></script>
