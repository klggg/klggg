...
<body>
  ...
  <div class="head">
    <div class="box980">
      <div class="logo"><a href="/"><img src="<? if (!isset($this->magic_vars['tempdir'])) $this->magic_vars['tempdir'] = ''; echo $this->magic_vars['tempdir']; ?>/longbao/images/logo.jpg" width="219" height="64" /></a></div>
      <div class="nav">
        <ul>
