...
<meta http-equiv="Content-Type" content="text/html; charset=gb2312" />
 ...
 <meta name="description" content="<?php if (!isset($this->magic_vars['_G']['articles']['contents'])) $this->magic_vars['_G']['articles']['contents']=''; ;if (  $this->magic_vars['_G']['articles']['contents']!=""): ?><?php if (!isset($this->magic_vars['_G']['articles']['contents'])) $this->magic_vars['_G']['articles']['contents'] = '';$_tmp = $this->magic_vars['_G']['articles']['contents'];$_tmp = $this->magic_modifier("html_format",$_tmp,"");$_tmp = $this->magic_modifier("truncate",$_tmp,"60");echo $_tmp;unset($_tmp); ?><?php if (!isset($this->magic_vars['_G']['site_result']['description'])) $this->magic_vars['_G']['site_result']['description']=''; ;elseif (  $this->magic_vars['_G']['site_result']['description']!=""): ?><?php if (!isset($this->magic_vars['_G']['site_result']['description'])) $this->magic_vars['_G']['site_result']['description'] = ''; echo $this->magic_vars['_G']['site_result']['description']; ?><?php else: ?><?php if (!isset($this->magic_vars['_G']['system']['con_description'])) $this->magic_vars['_G']['system']['con_description'] = ''; echo $this->magic_vars['_G']['system']['con_description']; ?><?php endif; ?>" />
                    ...
                    <?php if (!isset($this->magic_vars['_G']['user_id'])) $this->magic_vars['_G']['user_id']=''; ;if (  $this->magic_vars['_G']['user_id']==""): ?>	 
                      ...
                      <a href="/index.php?user&q=login">登录</a>
                       ...
                       <?php else: ?>
                        ...
                        <a href="/?user&q=code/message">站内信(<?php if (!isset($this->magic_vars['_G']['message_result']['message_no'])) $this->magic_vars['_G']['message_result']['message_no'] = '';$_tmp = $this->magic_vars['_G']['message_result']['message_no'];$_tmp = $this->magic_modifier("default",$_tmp,"0");echo $_tmp;unset($_tmp); ?>)</a>  
    ...
    <div class="gain" id="userGain" style="z-index: 9; top: -290px; right: 0px; ">
      ...
      <div class="gain-cont">
       ...
       <?php else: ?>
        ...
        <p> 可 用 余 额：<font color="#ff6600">￥<?php if (!isset($this->magic_vars['var']['balance'])) $this->magic_vars['var']['balance'] = '';$_tmp = $this->magic_vars['var']['balance'];$_tmp = $this->magic_modifier("round",$_tmp,"2,3");$_tmp = $this->magic_modifier("default",$_tmp,"0.00");echo $_tmp;unset($_tmp); ?></font></p>
        ...
        <p>最近待收金额：<font color="#ff6600">￥<?php if (!isset($this->magic_vars['Devar']['recover_new_account'])) $this->magic_vars['Devar']['recover_new_account'] = '';$_tmp = $this->magic_vars['Devar']['recover_new_account'];$_tmp = $this->magic_modifier("default",$_tmp,"0.00");echo $_tmp;unset($_tmp); ?></font></p>
		 <p>最近待收日期：<font color="#ff6600"><?php if (!isset($this->magic_vars['Devar']['recover_new_time'])) $this->magic_vars['Devar']['recover_new_time'] = '';$_tmp = $this->magic_vars['Devar']['recover_new_time'];$_tmp = $this->magic_modifier("date_format",$_tmp,"Y-m-d");$_tmp = $this->magic_modifier("default",$_tmp,"-");echo $_tmp;unset($_tmp); ?></font></p>
        <?php unset($_magic_vars);unset($data); ?>
...
;    foreach ($_from as $this->magic_vars['key'] => $this->magic_vars['var']):
?>
         <a href="/notice/a<?php if (!isset($this->magic_vars['var']['id'])) $this->magic_vars['var']['id'] = ''; echo $this->magic_vars['var']['id']; ?>.html" target="_blank" title="<?php if (!isset($this->magic_vars['var']['name'])) $this->magic_vars['var']['name'] = ''; echo $this->magic_vars['var']['name']; ?>"><?php if (!isset($this->magic_vars['var']['name'])) $this->magic_vars['var']['name'] = '';$_tmp = $this->magic_vars['var']['name'];$_tmp = $this->magic_modifier("truncate",$_tmp,"14");echo $_tmp;unset($_tmp); ?>...</a>
	 <?php endforeach;else:echo $default; endif; unset($_from);unset($_magic_vars); ?>
...
?>
      <li>
        <table width="100%" border="0">
          <tr>
            <td rowspan="3" width="100"><div class="Recommend_mg2"><img src="<?php if (!isset($this->magic_vars['var']['user_id'])) $this->magic_vars['var']['user_id'] = '';$_tmp = $this->magic_vars['var']['user_id'];$_tmp = $this->magic_modifier("avatar",$_tmp,"");echo $_tmp;unset($_tmp); ?>" width="75" height="75" /></div></td>
          ...
          <tr>
            ...
            <td width="190">借款期限：<?php if (!isset($this->magic_vars['var']['borrow_period'])) $this->magic_vars['var']['borrow_period']=''; ;if (  $this->magic_vars['var']['borrow_period'] == 0.03): ?>1天
							...
							<?php if (!isset($this->magic_vars['var']['borrow_period'])) $this->magic_vars['var']['borrow_period']='';if (!isset($this->magic_vars['var']['borrow_period'])) $this->magic_vars['var']['borrow_period']=''; ;elseif (  $this->magic_vars['var']['borrow_period'] >= 1 &&  $this->magic_vars['var']['borrow_period'] < 10): ?><?php if (!isset($this->magic_vars['var']['borrow_period'])) $this->magic_vars['var']['borrow_period'] = '';$_tmp = $this->magic_vars['var']['borrow_period'];$_tmp = $this->magic_modifier("truncate",$_tmp,"1");echo $_tmp;unset($_tmp); ?>个月
							<?php else: ?><?php if (!isset($this->magic_vars['var']['borrow_period'])) $this->magic_vars['var']['borrow_period'] = '';$_tmp = $this->magic_vars['var']['borrow_period'];$_tmp = $this->magic_modifier("truncate",$_tmp,"2");echo $_tmp;unset($_tmp); ?>个月
							<?php endif; ?></td>
            <td rowspan="2">
          ...
          <tr>
            <td width="200">信用等级：<?php if (!isset($this->magic_vars['var']['credit']['approve_credit'])) $this->magic_vars['var']['credit']['approve_credit'] = '';$_tmp = $this->magic_vars['var']['credit']['approve_credit'];$_tmp = $this->magic_modifier("credit",$_tmp,"credit");echo $_tmp;unset($_tmp); ?></td>
            ...
            <td>赎回方式： <?php if (!isset($this->magic_vars['var']['borrow_style'])) $this->magic_vars['var']['borrow_style'] = '';$_tmp = $this->magic_vars['var']['borrow_style'];$_tmp = $this->magic_modifier("linkages",$_tmp,"borrow_style");echo $_tmp;unset($_tmp); ?></td>
          </tr>
        </table>
      </li>
     <?php endforeach;else:echo $default; endif; unset($_from);unset($_magic_vars); ?>
