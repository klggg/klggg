...
0
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_common.htm', 1395154444, '2', './data/template/2_2_common_header_member_logging.tpl.php', './template/singcere_note', 'common/header_member_logging')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/pubsearchform.htm', 1395154444, '2', './data/template/2_2_common_header_member_logging.tpl.php', './template/singcere_note', 'common/header_member_logging')
;?>
