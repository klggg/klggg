...
0
|| checktplrefresh('./template/default/forum/discuz.htm', './template/singcere_note/common/header.htm', 1395154442, 'diy', './data/template/2_diy_forum_discuz.tpl.php', './template/singcere_note', 'forum/discuz')
|| checktplrefresh('./template/default/forum/discuz.htm', './template/singcere_note/common/footer.htm', 1395154442, 'diy', './data/template/2_diy_forum_discuz.tpl.php', './template/singcere_note', 'forum/discuz')
|| checktplrefresh('./template/default/forum/discuz.htm', './template/default/common/header_common.htm', 1395154442, 'diy', './data/template/2_diy_forum_discuz.tpl.php', './template/singcere_note', 'forum/discuz')
|| checktplrefresh('./template/default/forum/discuz.htm', './template/default/common/pubsearchform.htm', 1395154442, 'diy', './data/template/2_diy_forum_discuz.tpl.php', './template/singcere_note', 'forum/discuz')
;?>
