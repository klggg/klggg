...
0
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_common.htm', 1405829106, '2', './data/template/2_2_common_header_home_follow.tpl.php', './template/singcere_note', 'common/header_home_follow')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/pubsearchform.htm', 1405829106, '2', './data/template/2_2_common_header_home_follow.tpl.php', './template/singcere_note', 'common/header_home_follow')
;?>
