...
0
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_common.htm', 1405830431, '2', './data/template/2_2_common_header_member_register.tpl.php', './template/singcere_note', 'common/header_member_register')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/pubsearchform.htm', 1405830431, '2', './data/template/2_2_common_header_member_register.tpl.php', './template/singcere_note', 'common/header_member_register')
;?>
