...
//加载员工列表
//员工按体力排序
//http://k24.bizlife.com.cn/company/staff_batch_select.php?state=43&return=%2Fcompany%2Fadmin_hr.php
//http://k1.bizlife.com.cn/company/staff_batch_select.php?page=1&state=3&orderby=leftexec&op=desc
//page 取第几页
function biz_get_staff(state)
{
	if(!biz_check())
		return false;
	...
	var server_url	= biz_current_server_url()+'/company/staff_batch_select.php';	//进修用
