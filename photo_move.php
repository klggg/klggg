...
//$photo_source_path = 'D:/����/[Pictures]'; //pad
...
//$PhotoMove_obj->run( 'D:/����/[MobileBackup]');
//$PhotoMove_obj->run('D:/����/[Pictures]');
//$PhotoMove_obj->run('D:/����/[Videos]');

$PhotoMove_obj->run('D:/����/ggg/pic_new_month/unkown');
