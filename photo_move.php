...
//$photo_source_path = 'D:/快盘/[Pictures]'; //pad
...
//$PhotoMove_obj->run( 'D:/快盘/[MobileBackup]');
//$PhotoMove_obj->run('D:/快盘/[Pictures]');
//$PhotoMove_obj->run('D:/快盘/[Videos]');

$PhotoMove_obj->run('D:/快盘/ggg/pic_new_month/unkown');
